...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _core=require("@cycle/core"),_dom=require("@cycle/dom"),_cycleRestart=require("cycle-restart"),_cycleKeys=require("cycle-keys"),_isolate=require("@cycle/isolate"),_isolate2=_interopRequireDefault(_isolate),_preventDefaultDriver=require("./src/drivers/prevent-default-driver"),_preventDefaultDriver2=_interopRequireDefault(_preventDefaultDriver),app=require("./src/app")["default"],drivers={DOM:(0,_cycleRestart.restartable)((0,_dom.makeDOMDriver)(".app"),{pauseSinksWhileReplaying:!1}),Keys:(0,_cycleRestart.restartable)((0,_cycleKeys.makeKeysDriver)()),preventDefault:_preventDefaultDriver2["default"]},_run=(0,_core.run)(app,drivers),sinks=_run.sinks,sources=_run.sources;module.hot&&module.hot.accept("./src/app",function(){app=require("./src/app")["default"],(0,_cycleRestart.restart)(app,drivers,{sinks:sinks,sources:sources},_isolate2["default"])});

},{"./src/app":69,"./src/drivers/prevent-default-driver":70,"@cycle/core":2,"@cycle/dom":3,"@cycle/isolate":11,"cycle-keys":15,"cycle-restart":16}],2:[function(require,module,exports){
"use strict";
 ...
 */
},{"./mock-dom-source":5,"./render-dom":6,"./render-html":7,"./virtual-hyperscript":10,"./virtual-hyperscript-svg":9,"hyperscript-helpers":21}],4:[function(require,module,exports){
"use strict";
...
},{"./fromevent":4,"./transposition":8,"./virtual-hyperscript":10,"matches-selector":27,"rx":29,"vdom-parser":35,"virtual-dom/diff":42,"virtual-dom/patch":43}],7:[function(require,module,exports){
"use strict";
...
},{"./transposition":8,"rx":29,"vdom-to-html":39}],8:[function(require,module,exports){
"use strict";
...
},{"rx":29,"virtual-dom/vnode/vnode":62}],9:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
// END Cycle.js-specific code <<<<<<<<<<
},{"./virtual-hyperscript":10,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":50,"virtual-dom/virtual-hyperscript/svg-attribute-namespace":54,"x-is-array":67}],10:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
/* eslint-enable */
},{"virtual-dom/virtual-hyperscript/hooks/ev-hook.js":51,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js":52,"virtual-dom/virtual-hyperscript/parse-tag.js":53,"virtual-dom/vnode/is-thunk":56,"virtual-dom/vnode/is-vhook":57,"virtual-dom/vnode/is-vnode":58,"virtual-dom/vnode/is-vtext":59,"virtual-dom/vnode/is-widget":60,"virtual-dom/vnode/vnode.js":62,"virtual-dom/vnode/vtext.js":64,"x-is-array":67}],11:[function(require,module,exports){
"use strict";
...
exports.makeKeysDriver = makeKeysDriver;
...
function makeKeysDriver() {
  return function keysDriver() {
    ...
    methods['isDown'] = function (key) {
      var code = (0, _keycode2.default)(key);

      var down$ = _rx.Observable.fromEvent(document.body, 'keydown').filter(function (ev) {
        return ev.keyCode === code;
      }).map(function (ev) {
        return true;
      });

      var up$ = _rx.Observable.fromEvent(document.body, 'keyup').filter(function (ev) {
        return ev.keyCode === code;
      }).map(function (ev) {
        return false;
      });

      return _rx.Observable.merge(down$, up$).startWith(false);
    };

    return methods;
  };
}
},{"keycode":25,"rx":29}],16:[function(require,module,exports){
'use strict';
...
function rerunner(run, isolate) {
  var sourcesAndSinks = {};
  var first = true;
  return function (main, drivers) {
    var timeToTravelTo = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
...
},{"./restartable":17,"@cycle/core":2,"rx":29}],17:[function(require,module,exports){
'use strict';
...
function restartable(driver) {
  ...
  function restartableDriver(sink$) {
    ...
    if (sink$ && pauseSinksWhileReplaying) {
      filteredSink$ = sink$.filter(function () {
        return !replaying;
      });
    }
...
},{"rx":29}],18:[function(require,module,exports){
/*!
 * escape-html
...
},{"individual/one-version":23}],20:[function(require,module,exports){
(function (global){
...
},{"min-document":12}],21:[function(require,module,exports){
'use strict';
...
},{"./namespace-map":36,"./property-map":37,"virtual-dom/vnode/vnode":62,"virtual-dom/vnode/vtext":64}],36:[function(require,module,exports){
...
},{"./property-config":40,"escape-html":18}],39:[function(require,module,exports){
var escape = require('escape-html');
...
},{"./create-attribute":38,"./void-elements":41,"escape-html":18,"param-case":28,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":50,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":52,"virtual-dom/vnode/is-thunk":56,"virtual-dom/vnode/is-vnode":58,"virtual-dom/vnode/is-vtext":59,"virtual-dom/vnode/is-widget":60,"xtend":68}],40:[function(require,module,exports){
/**
 * Attribute types.
 */
...
},{"../vnode/is-vhook.js":57,"is-object":24}],45:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":55,"../vnode/is-vnode.js":58,"../vnode/is-vtext.js":59,"../vnode/is-widget.js":60,"./apply-properties":44,"global/document":20}],46:[function(require,module,exports){
...
},{"./create-element":45,"./dom-index":46,"./patch-op":47,"global/document":20,"x-is-array":67}],49:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":19}],52:[function(require,module,exports){
'use strict';
...
},{"browser-split":13}],54:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-vhook":57,"is-object":24}],66:[function(require,module,exports){
var isArray = require("x-is-array")
...
},{"../vnode/handle-thunk":55,"../vnode/is-thunk":56,"../vnode/is-vnode":58,"../vnode/is-vtext":59,"../vnode/is-widget":60,"../vnode/vpatch":63,"./diff-props":65,"x-is-array":67}],67:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function updateText(e){return function(t){var n=e.shiftKey,r=String.fromCharCode(e.which),i=n?r:r.toLowerCase();return Object.assign({},t,{text:t.text+i})}}function removeText(e){return function(t){var n="";(e.metaKey||e.ctrlKey)&&(n="\n"),e.altKey&&(n=" ");var r=t.text.split(n).slice(0,t.text.split(n).length-1).join(n);return Object.assign({},t,{text:r})}}function addPeriod(){return function(e){return Object.assign({},e,{text:e.text+"."})}}function addNewLine(){return function(e){return Object.assign({},e,{text:e.text+"\n"})}}function toggleInstructions(){return function(e){return Object.assign({},e,{instructions:!e.instructions})}}function renderText(e){var t=new _showdown2["default"].Converter({strikethrough:!0,tasklists:!0,smoothLivePreview:!0,parseImgDimensions:!0});return t.makeHtml(e)}function App(e){var t=e.DOM,n=e.Keys,r=t.select(".toggle-instructions").events("click").map(function(e){return toggleInstructions()}),i=n.press(),o=n.down("backspace"),u=n.press("space"),s=o.map(function(e){return removeText(e)}),c=i.filter(function(e){return 8!==e.which&&46!==e.which}).map(function(e){return updateText(e)}),a=n.down(".").map(function(e){return addPeriod()}),d=n.down("enter").map(function(e){return addNewLine()}),l=_rx.Observable.merge(c,s,a,d,r),f=l.startWith(initialState).scan(function(e,t){return t(e)});return{DOM:f.map(function(e){return(0,_dom.div)(".container",[(0,_dom.div)(".toggle-instructions","Toggle Instructions"),(0,_dom.div)(".instructions",{style:{display:e.instructions?"block":"none"}},"Just write! You can use markdown syntax. Have fun!"),(0,_dom.div)(".text",{innerHTML:renderText(e.text)})])}),preventDefault:_rx.Observable.merge(o,u)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=App;var _dom=require("@cycle/dom"),_keycode=require("keycode"),_keycode2=_interopRequireDefault(_keycode),_rx=require("rx"),_showdown=require("showdown"),_showdown2=_interopRequireDefault(_showdown),initialState={text:"",instructions:!0};

},{"@cycle/dom":3,"keycode":25,"rx":29,"showdown":34}],70:[function(require,module,exports){
"use strict";function preventDefaultDriver(e){return e.subscribe(function(e){e.preventDefault()}),Object.create(null)}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=preventDefaultDriver;
