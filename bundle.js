...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _core=require("@cycle/core"),_dom=require("@cycle/dom"),_cycleRestart=require("cycle-restart"),_keysDriver=require("./src/drivers/keys-driver"),_isolate=require("@cycle/isolate"),_isolate2=_interopRequireDefault(_isolate),_preventDefaultDriver=require("./src/drivers/prevent-default-driver"),_preventDefaultDriver2=_interopRequireDefault(_preventDefaultDriver),app=require("./src/app")["default"],drivers={DOM:(0,_cycleRestart.restartable)((0,_dom.makeDOMDriver)(".app"),{pauseSinksWhileReplaying:!1}),Keys:(0,_cycleRestart.restartable)((0,_keysDriver.makeKeysDriver)()),preventDefault:_preventDefaultDriver2["default"]},_run=(0,_core.run)(app,drivers),sinks=_run.sinks,sources=_run.sources;module.hot&&module.hot.accept("./src/app",function(){app=require("./src/app")["default"],(0,_cycleRestart.restart)(app,drivers,{sinks:sinks,sources:sources},_isolate2["default"])});

},{"./src/app":68,"./src/drivers/keys-driver":69,"./src/drivers/prevent-default-driver":70,"@cycle/core":2,"@cycle/dom":3,"@cycle/isolate":11,"cycle-restart":15}],2:[function(require,module,exports){
"use strict";
...
},{"rx":28}],3:[function(require,module,exports){
"use strict";
...
},{"./fromevent":4,"./transposition":8,"./virtual-hyperscript":10,"matches-selector":26,"rx":28,"vdom-parser":34,"virtual-dom/diff":41,"virtual-dom/patch":42}],7:[function(require,module,exports){
"use strict";
...
},{"./transposition":8,"rx":28,"vdom-to-html":38}],8:[function(require,module,exports){
"use strict";
...
},{"rx":28,"virtual-dom/vnode/vnode":61}],9:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
},{"./restartable":16,"@cycle/core":2,"rx":28}],16:[function(require,module,exports){
'use strict';
...
},{"rx":28}],17:[function(require,module,exports){
/*!
 * escape-html
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function updateText(e){return function(t){var n=e.shiftKey,r=String.fromCharCode(e.which),i=n?r:r.toLowerCase();return Object.assign({},t,{text:t.text+i})}}function removeText(e){return function(e){var t=e.text.split("").slice(0,e.text.length-1).join("");return Object.assign({},e,{text:t})}}function addPeriod(){return function(e){return Object.assign({},e,{text:e.text+"."})}}function addNewLine(){return function(e){return Object.assign({},e,{text:e.text+"\n"})}}function toggleInstructions(){return function(e){return Object.assign({},e,{instructions:!e.instructions})}}function renderText(e){var t=new _showdown2["default"].Converter({strikethrough:!0,tasklists:!0,smoothLivePreview:!0,parseImgDimensions:!0});return t.makeHtml(e)}function App(e){var t=e.DOM,n=e.Keys,r=t.select(".toggle-instructions").events("click").map(function(e){return toggleInstructions()}),i=n.presses("keypress"),o=n.presses("keydown","backspace"),s=n.presses("keypress","space"),u=o.map(function(e){return removeText(e)}),c=i.filter(function(e){return 8!==e.which&&46!==e.which}).map(function(e){return updateText(e)}),a=n.presses("keydown",".").map(function(e){return addPeriod()}),d=n.presses("keydown","enter").map(function(e){return addNewLine()}),f=_rx.Observable.merge(c,u,a,d,r),l=f.startWith(initialState).scan(function(e,t){return t(e)});return{DOM:l.map(function(e){return(0,_dom.div)(".container",[(0,_dom.div)(".toggle-instructions","Toggle Instructions"),(0,_dom.div)(".instructions",{style:{display:e.instructions?"block":"none"}},"Just write! You can use markdown syntax. Have fun!"),(0,_dom.div)(".text",{innerHTML:renderText(e.text)})])}),preventDefault:_rx.Observable.merge(o,s)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=App;var _dom=require("@cycle/dom"),_keycode=require("keycode"),_keycode2=_interopRequireDefault(_keycode),_rx=require("rx"),_showdown=require("showdown"),_showdown2=_interopRequireDefault(_showdown),initialState={text:"",instructions:!0};

},{"@cycle/dom":3,"keycode":24,"rx":28,"showdown":33}],69:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function makeKeysDriver(){return function(){return{presses:function(e,r){var t=_rx.Observable.fromEvent(document.body,e);return r&&!function(){var e=(0,_keycode2["default"])(r);t=t.filter(function(r){return r.keyCode===e})}(),t}}}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.makeKeysDriver=makeKeysDriver;var _rx=require("rx"),_keycode=require("keycode"),_keycode2=_interopRequireDefault(_keycode);

},{"keycode":24,"rx":28}],70:[function(require,module,exports){
